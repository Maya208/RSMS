...
!function(a,b){
	...
	function r(a,c){
		if(S("enumType",a),S("keyOrValue",c),"string"==typeof c){var d=a[c];
...
function u(a,b,c,d){
	if((0>d||d>=c.stepCount)&&R(Y),!(b.forceMoveForward&&d<c.currentIndex)){
		...
		function x(b,c,d,e,f){
			...
			return(null==f.contentMode||f.contentMode===$.html)&&i.html(f.content),0===e?g.prepend(i).prepend(h):k(b,e-1).after(i).after(h),
			K(b,d,i,e),
			N(b,c,d,h,e),
			F(b,c,d,e),
		...
		function B(a,b,c,d){
			...
			if(d>=0&&d<c.stepCount&&!(b.forceMoveForward&&d<c.currentIndex)){
				...
				return g._enableAria(),f.click(),e===c.currentIndex&&h?(g._enableAria(!1),!1):!0}return!1
			}
			function C(b){
				b.preventDefault();
			...
			function E(b,c,d,e){
				...
				if(null!=e){
					var i=j(b,e);i.parent().addClass("done").removeClass("error")._selectAria(!1),
				...
				switch(i){
					...
					d.transitionElement=k,l[m](j,function(){
						...
						c.transitionElement&&(c.transitionElement[o](j,function(){
							a(this)._showAria()}).promise().done(g),
													...
													a.fn.steps.remove=function(a){
														...
														a.fn.steps.setStep=function(){
															...
															a.fn.steps.skip=function(){
																...
																bb=a.fn.steps.stepModel={title:"",
																content:"",
																contentUrl:"",
																contentMode:$.html,
																contentLoaded:!1},
																cb=a.fn.steps.defaults={headerTag:"h1",
																bodyTag:"div",
